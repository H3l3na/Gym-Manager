...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "GymManager3.MobileApp.Android.dll" comes first in this list. */
		"GymManager3.MobileApp.Android.dll",
		"Flurl.dll",
		"Flurl.Http.dll",
		"FormsViewGroup.dll",
		"GymManager3.MobileApp.dll",
		"Newtonsoft.Json.dll",
